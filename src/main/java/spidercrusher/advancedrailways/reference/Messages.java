...
public class Messages {
    ...
    public static final class Common {
        private static final String COMMON_PREFIX = "common." + Reference.LOWERCASE_MOD_ID + ":";

        public static final String UNKNOWN_PLAYER = COMMON_PREFIX + "unknownPlayer";
    }

    public static final class Signalling {
        private static final String SIGNALLING_PREFIX = "signalling." + Reference.LOWERCASE_MOD_ID + ":";
    ...
    public static final class Tooltip {
        public static final String TOOLTIP_PREFIX = "tooltip." + Reference.LOWERCASE_MOD_ID + ":";
